...
<template>
  <div class="pt-[140px] md:pt-[160px] lg:pt-[200px] pb-20 min-h-screen bg-[#081a24]">
    <Head>
      <title>Pendaftaran Santri Baru | Pondok Modern Al-Hikmah</title>
      <meta name="description" content="Sistem Pendaftaran Santri Baru Pondok Modern Al-Hikmah. Daftar sekarang secara online.">
    </Head>
