                ...
                Section::make('Data & Legalitas')
                    ...
                    ->schema([
                        Repeater::make('legalities')
                            ...
                            ->schema([
                                TextInput::make('name')
                                    ->label('Nama Dokumen / Izin (contoh: NSPP, Akreditasi, NPSN)')
                                    ->required(),
                                TextInput::make('value')
                                    ->label('Nomor / Nilai (contoh: 51000..., A Unggul)')
                                    ->required(),
                            ])
                            ->columns(2)
                            ->columnSpanFull()
                        ...
                        FileUpload::make('background_image')
                            ...
                            ->image()
                            ->multiple()
                            ->directory('profiles-backgrounds')
                            ->columnSpanFull(),
                    ])->columns(2),
